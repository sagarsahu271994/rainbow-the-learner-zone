    ...
    <header className="sticky top-0 z-40 border-b border-slate-100 bg-white/90 backdrop-blur-xl">
      ...
      <div className="shell flex h-20 items-center justify-between">
        <Link href="/" className="flex items-center gap-3" aria-label="Rainbow The Learner Zone home">
          <Image src="/logo.png" width={58} height={58} alt="Rainbow The Learner Zone" className="h-14 w-14 rounded-2xl object-cover" priority />
          <div>
            <p className="text-sm font-black leading-tight sm:text-base">Rainbow</p>
            <p className="text-[10px] font-bold uppercase tracking-[.15em] text-slate-500">The Learner Zone</p>
          </div>
        </Link>
